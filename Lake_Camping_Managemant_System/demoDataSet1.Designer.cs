...
namespace Lake_Camping_Managemant_System {
    ...
    public partial class demoDataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmpDataTable : global::System.Data.TypedTableBase<EmpRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmpRow AddEmpRow(string name, string department, string phoneno) {
        ...
        public partial class EmpRow : global::System.Data.DataRow {
            ...
            public string phoneno {
                get {
                    try {
                        return ((string)(this[this.tableEmp.phonenoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'phoneno\' in table \'Emp\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmp.phonenoColumn] = value;
                }
            }
            ...
            public bool IsphonenoNull() {
                return this.IsNull(this.tableEmp.phonenoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetphonenoNull() {
                this[this.tableEmp.phonenoColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Lake_Camping_Managemant_System.demoDataSet1TableAdapters {
    ...
    public partial class EmpTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Emp` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Emp` (`name`, `department`, `phoneno`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Emp` SET `name` = ?, `department` = ?, `phoneno` = ? WHERE ((`ID` = ?) AN" +
                "D ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `phoneno` IS NULL" +
                ") OR (`phoneno` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lake_Camping_Managemant_System.Properties.Settings.Default.demoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, name, department, phoneno FROM Emp";
        ...
        public virtual int Fill(demoDataSet1.EmpDataTable dataTable) {
        ...
        public virtual demoDataSet1.EmpDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            demoDataSet1.EmpDataTable dataTable = new demoDataSet1.EmpDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(demoDataSet1.EmpDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_name, string Original_phoneno) {
        ...
        public virtual int Insert(string name, string department, string phoneno) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string department, string phoneno, int Original_ID, string Original_name, string Original_phoneno) {
            if ((name == null)) {
